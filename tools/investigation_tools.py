...
def get_recent_commits(repository_name: str, limit: int = 10) -> list:
    ...
    Use this to check what code changes happened recently that
    might be related to the incident.
    """
    return github.get_recent_commits(repository_name, limit)
...
def get_pull_requests(repository_name: str, state: str = "all", limit: int = 10) -> list:
    ...
    Use this to check what changes were merged or are pending.
    """
    return github.get_pull_requests(repository_name, state, limit)
...
def search_github_issues(repository_name: str, keyword: str) -> list:
    ...
    Use this to find past issues related to the incident's symptoms.
    """
    return github.search_issues(repository_name, keyword)
...
def search_github_pull_requests(repository_name: str, keyword: str) -> list:
    ...
    Use this to find code changes related to the incident's symptoms.
    """
    return github.search_pull_requests(repository_name, keyword)
...
def get_file_content(repository_name: str, file_path: str, branch: str = "main") -> str:
    ...
    Use this to inspect configuration or code files mentioned in the ticket.
    """
    return github.get_file_content(repository_name, file_path, branch)
...
def search_confluence_pages(keyword: str, limit: int = 10) -> list:
    ...
    Use this to find relevant runbooks or past incident documentation.
    """
    return confluence.search_pages(keyword, limit)
...
def get_confluence_page_content(page_id: str) -> str:
    ...
    Use this after finding a relevant page via search_confluence_pages.
    """
